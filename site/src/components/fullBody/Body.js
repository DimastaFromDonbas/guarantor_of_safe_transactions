...
function Body() {
    ...
    return <div className="container-body-v1 bg-img" >
        ...
        <div className='container bg-img'>
            <div className='block-text-free'>
                ...
                <p className='text-free'>
                    ...
                    имеют доступ обе стороны, а также консультанты {nameTheSite.name}, которых можно привлечь при необходимости.
                </p>
                <p className='text-free'>
                    <b>Оплата за посредничество минимальна. </b>
                    Еще одно преимущество — низкая комиссия, которую
                    взимает гарант безопасных сделок {nameTheSite.name}. Это небольшая сумма, но даже она дает вам уверенность, что вас не
                    обманут.
                </p>
                <p className='text-free'>
                    ...
                    онлайн-сделок {nameTheSite.name} — ваш щит от нечестных продавцов и покупателей, нерадивых исполнителей, необязательных
                ...
                <p className='text-free'>
                    ...
                    очень и очень велик! Пользуйтесь гарант сервисом {nameTheSite.name}. И помните, мошенник никогда, не при каких условиях не
        ...
        <div className='container bg-img'>
            <div className='block-text-free'>
                <p className="text-free"><b>{nameTheSite.name}</b> - предлагает безопасные сделки в интернете с сайтами, доменами, социальными сетями, аккаунтами онлайн-игр,
                ...
                <p className="text-free">Относительно новый игрок на рынке социальных
                    сетей - telegram. Он сильно отличается от
                ...
                <div className='tytleStaleComents' id='reviews'>
                    ...
                    <Carousel fade={true} slide={true} touch={"true"}>
                        ...
                        <div className='card-body-coments'>
                            ...
                            Очень хороший сервис продаж, всем рекомендую, сам продаю на ней больше года, поддержка топ, покупатели и продавцы лучшие!
                        </div>
                        </div>
                        <div className='containerCard'>
                            <div className="card-header-coments">
                        ...
                        <div className='card-body-coments'>
                            ...
                            Отличный проверенный сайт для продажи игрового имущества и т. д, сам пользуюсь и вам советую, это вам не какой-то ноунейм сайт где вас кинут и пошлют подальше.
                        </div>
                        </div>
                        <div className='containerCard'>
                            <div className="card-header-coments">
                        ...
                        <div className='card-body-coments'>
                            ...
                            Пользуюсь услугами продолжительное время. Было дело что покупал/продавал аккаунты, было дело что покупал/продавал золото. Всё отлично и всём советую.
                        </div>
                        </div>
                        <div className='containerCard'>
                            <div className="card-header-coments">
                        ...
                        <div className='card-body-coments'>
                            ...
                            Со стороны покупателя площадка максимально доступна и понятна, а главное по возможности защищена, 100% Рекомендую ! Площадка свои роль в сделке выполняет.
                        </div>
                        </div>
                        <div className='containerCard'>
                            <div className="card-header-coments">
                        ...
                        <div className='card-body-coments'>
                            ...
                            Пользуюсь от случая к случаю, покупаю иногда всякую фигню в играх или аккаунты. Выбирал всегда аккуратно продавцов и ни разу не попал на кидал.
                        </div>
                        </div>
                        <div className='containerCard'>
                            <div className="card-header-coments">
                        ...
                        <div className='card-body-coments'>
                            ...
                            Поддержка работает очень быстро, все сотрудники понимают суть своей работы и помогают в любой ситуации. Много раз совершал покупки, все понравилось, удобный интерфейс, приятный дизайн. В общем, все на уровне.
                        </div>
                        </div>
                        </Carousel.Item>
                        </Carousel>
                        <div style={{textAlign: "center", color: "antiquewhite",marginTop:'10px'}}>
                        <h6> Оставление отзыва после совершения сделки на нашем гарант сервисе это — ваш шанс высказаться и повлиять на улучшение качества наших услуг.<br/> Благодаря вашей добросовестности и времени, потраченному на оставление отзыва, вы способствуете росту нашего сообщества и улучшению общего эффекта. <br/>Отзыв вы можете оставить после завершения сделки.</h6>
                        </div>
            </div>
