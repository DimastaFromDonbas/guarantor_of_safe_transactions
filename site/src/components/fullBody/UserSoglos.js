                        ...
                        <div className="docs-popup-wrapper">
                            ...
                            <div className="docs-popup-wrapper-description">
                                <div className="jspContainer">
                                    ...
                                    пространства
                                    доменного имени gamesgun.ru, обеспечивающих взаимодействие между Пользователями.<br/>
                                    ...
                                    Биржа gamesgun.ru предлагает Пользователям доступ к широкому спектру сервисов, без
                                    ...
                                    5.1.Пользователь Сайта gamesgun.ru имеет следующие права и обязанности:<br/>
                                    ...
                                    Записи.<br/>
                                    5.2. Пользователям Сайта gamesgun.ru запрещено:<br/>
                                    ...
                                    5.2.6. Нарушения любым способом нормальной работы сайта gamesgun.ru;<br/>
                                    ...
                                    gamesgun.ru (или представители администрации в лице модераторов) имеют право:<br/>
                                    ...
                                    Вы согласны с тем, что Сайт gamesgun.ru оставляет за собой право прекратить действие Вашей
                                    ...
                                    использованием
                                    Учетной Записи подразумевается авторизация Пользователя на Сайте. 7.4. gamesgun.ru может в
                                    любой
                                    момент закрыть любой из своих сервисов, с или без предварительного уведомления. gamesgun.ru
                                    ...
                                    9.1.1. Вы используете сервисы gamesgun.ru на Ваш собственный риск. Службы предоставляются
                                    "как
                                    есть". gamesgun.ru не принимает на себя никакой ответственности, в том числе и за
                                    соответствие
                                    сервисов цели пользователя;<br/>
                                    9.1.2. gamesgun.ru не гарантирует, что: сервисы будут соответствовать Вашим требованиям;
                                    сервисы
                                    ...
                                    9.1.3. Любые материалы, полученные Вами с использованием сервисов gamesgun.ru, Вы можете
                                    ...
                                    9.1.4.gamesgun.ru не несет ответственности за любые прямые или непрямые убытки, произошедшие
                                    ...
                                    вывoды на
                                    реальные электронные кошельки, банковские карты и тп. не возможны. Биржа gamesgun.ru не
                                    несет
                                    ...
                                    11.1. Соглашение является юридически обязывающим договором между Вами и gamesgun.ru и
                                    регламентирует использование Вами сервисов gamesgun.ru. Соответствующими договорами на Вас
                                    также
                                    ...
                                    11.2. Вы и gamesgun.ru соглашаетесь на то, что все возможные споры по поводу Соглашения
                                    будут
                                    разрешаться по нормам российского права.<br/>
                                    11.3. Ничто в Соглашении не может пониматься как установление между Вами и gamesgun.ru
                                    агентских
                                    ...
                                    Соглашения.<br/>
                                    11.5. Бездействие со стороны gamesgun.ru в случае нарушения Вами либо иными пользователями
                                    положений Соглашения не лишает gamesgun.ru права предпринять соответствующие действия в
                                    защиту
                                    своих интересов позднее, а также не означает отказа gamesgun.ru от своих прав в случае
                                    ...
                                    действие учетной записи Пользователя на gamesgun.ru в любое время без
                                    ...
                                    14.3. Общество вправе удалить учетную запись Пользователя на gamesgun.ru и/или
                                    ...
                                    программы gamesgun.ru, целиком либо какие-либо части Сервисов gamesgun.ru
                                    ...
                                    15.2. Все объекты, доступные при помощи Сервисов и gamesgun.ru, в том числе
                                    ...
                                    Сервисов), а также любой контент, размещенный на Сервисах и gamesgun.ru,
                                    ...
                                    и gamesgun.ru возможно только в рамках функционала, предлагаемого тем или
                                    иным Сервисом. Никакие элементы содержания Сервисов и gamesgun.ru, а также
                                    любой контент, размещенный в Сервисах и gamesgun.ru, не могут быть
                                    ...
                                    и Обществом относительно порядка использования Сервисов gamesgun.ru
