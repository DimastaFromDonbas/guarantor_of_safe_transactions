    ...
    return <>
        <div className="nav-account__content">
                        ...
                        <div className="output-description-info-block">
                            <div style={ SSizeBlock } className="output-id">ID</div>
                            <div style={ SSizeBlock } className="output-date">Дата</div>
                            <div style={ SSizeBlock } className="output-sum">Сумма</div>
                        </div>
                        {myRefills?.map((item, index) => <div className="flex-info-block" key={index}>
                            <div style={ SSizeBlock } className="output-id">{item.id}</div>
                            <div style={ SSizeBlock } className="output-date">{item.time}</div>
